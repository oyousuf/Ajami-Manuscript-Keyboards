...
KeymanWeb.KR(new Keyboard_soninke________________());
}
function Keyboard_soninke________________()
{
  var modCodes = keyman.osk.modifierCodes;
  var keyCodes = keyman.osk.keyCodes;

  this._v=(typeof keyman!="undefined"&&typeof keyman.version=="string")?parseInt(keyman.version,10):9;
  this.KI="Keyboard_soninke________________";
  this.KN="Soninke سࣷونِکَنْخَنّࣹ‎";
  this.KMINVER="10.0";
  this.KV={F:' 1em "Arial"',K102:0};
  this.KV.KLS={
    "shift": ["ـ","!","@","#","$","%","^","&","*","(",")","_","+","","","","ڧ","و","ع","ر","ث","ي","ࣸ","ِ","ٌ","","{","}","|","","","","أ","ش","ذ","ڢ","غ","ح","ج","ک","ل","؛","\"","","","","","","","ز","خ","ض","ظ","ب","ن","م","<",">","؟","","","","","",""],
    "default": ["ء","١","٢","٣","٤","٥","٦","٧","٨","٩","٠","ً","ٍ","","","","ڧ","و","ع","ر","ت","ي","ࣸ","ِ","ٌ","","[","]","\\","","","","ا","س","د","ڢ","ݣ","ھ","ج","ک","ل","ّ","َ","","","","","","","ز","خ","ص","ط","ب","ن","م","،",".","ْ","","","","","",""]
  };
